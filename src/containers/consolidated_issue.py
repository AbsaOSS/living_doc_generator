...
class ConsolidatedIssue:
    def __init__(self, repository_issue):
        ...
        self.organization_name = repository_issue.repository.organization_name
        self.repository_name = repository_issue.repository.repository_name
